...
class Robo:
    ...
    def controle(self, obj):
        ...
        if errox > 0:
            robo.ax = math.cos(math.radians(robo.angulo)) * (errox * kpa + kia * erroi[0] + kda * errod[0])
            robo.ay = math.sin(math.radians(robo.angulo)) * (erroy * kpa + kia * erroi[1] + kda * errod[1])
        ...
        self.a_angular = erroang * kpang + kiang * erroi[2] + kdang * errod[2]
